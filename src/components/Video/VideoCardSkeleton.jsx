...
export default function VideoCardSkeleton() {
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-lg overflow-hidden animate-pulse">
            ...
            <div className="p-4 space-y-3">
                ...
                <div className="h-9 w-full rounded-md bg-gray-200 dark:bg-gray-700 mt-4" />
            </div>
        </div>
    );
}
